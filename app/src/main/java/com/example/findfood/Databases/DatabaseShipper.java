...
public class DatabaseShipper {
    ...
    public void insert(Shipper item){
        ...
        Shipper shipperTest = new Shipper(item.getEmail(), item.getPassword(), item.getName(), item.getPhone(), item.getImage(), item.getDiachi(), item.getNgaySinh(), item.getGioiTinh(), key, "active");
